...
describe("OcrOrchestrator", () => {
    let orchestrator;
    beforeEach(() => {
        orchestrator = new ocrOrchestrator_service_1.OcrOrchestrator();
        jest.clearAllMocks();
        // Mock configuration
    ...
    describe("extractText", () => {
        ...
        it("should throw error when all methods fail", async () => {
            ...
            await expect(orchestrator.extractText("/test/document.pdf")).rejects.toThrow("All OCR methods failed");
        });
        it("should throw error when no OCR methods are enabled", async () => {
            ...
            await expect(orchestrator.extractText("/test/document.pdf")).rejects.toThrow("No OCR methods available");
        });
    });
    describe("processDocumentWithMetrics", () => {
        it("should return result with quality assessment and performance metrics", async () => {
            ...
            const result = await orchestrator.processDocumentWithMetrics("/test/document.pdf");
...
//# sourceMappingURL=ocrOrchestrator.test.js.map