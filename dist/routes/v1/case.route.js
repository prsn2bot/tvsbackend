...
router.get("/assigned", auth_middleware_1.authenticate, (0, auth_middleware_1.hasRole)(["cvo", "legal_board"]), (0, rateLimitMiddleware_1.default)(), subscriptionFeature_middleware_1.default, case_controller_1.CaseController.getCasesAssignedToUser);
...
router.post("/:caseId/review", auth_middleware_1.authenticate, (0, auth_middleware_1.hasRole)(["cvo", "legal_board", "owner"]), (0, rateLimitMiddleware_1.default)(), subscriptionFeature_middleware_1.default, (0, validation_middleware_1.validateAll)(case_dto_1.SubmitReviewDto, undefined, case_dto_1.CaseParamsDto, "case"), case_controller_1.CaseController.submitReview);
// GET /:caseId/documents - Get case documents for review
router.get("/:caseId/documents", auth_middleware_1.authenticate, (0, auth_middleware_1.hasRole)(["cvo", "legal_board", "owner"]), (0, rateLimitMiddleware_1.default)(), subscriptionFeature_middleware_1.default, (0, validation_middleware_1.validateParams)(case_dto_1.CaseParamsDto, "case"), case_controller_1.CaseController.getCaseDocumentsForReview);
// POST /:caseId/assign-cvo - Assign case to CVO (admin only)
router.post("/:caseId/assign-cvo", auth_middleware_1.authenticate, (0, auth_middleware_1.hasRole)(["admin", "owner"]), (0, rateLimitMiddleware_1.default)(), subscriptionFeature_middleware_1.default, (0, validation_middleware_1.validateParams)(case_dto_1.CaseParamsDto, "case"), case_controller_1.CaseController.assignCaseToCVO);
// POST /:caseId/assign-legal-board - Assign case to legal board (admin only)
router.post("/:caseId/assign-legal-board", auth_middleware_1.authenticate, (0, auth_middleware_1.hasRole)(["admin", "owner"]), (0, rateLimitMiddleware_1.default)(), subscriptionFeature_middleware_1.default, (0, validation_middleware_1.validateParams)(case_dto_1.CaseParamsDto, "case"), case_controller_1.CaseController.assignCaseToLegalBoard);
