...
} else if (env.NODE_ENV === "production" && !env.BASE_URL) {
  console.warn(
    "WARNING: NODE_ENV is production, but BASE_URL is not set. Swagger documentation might point to an incorrect URL."
  );
}
...
For technical support, please contact our development team.
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          bearerFormat: "JWT",
          description:
            'JWT Authorization header using the Bearer scheme. Example: "Authorization: Bearer {token}". In Swagger UI, click the Authorize button and enter your token.',
        },
      },
      parameters: {
        PageParam: {
      ...
      UserCreationRequest: {
        ...
        properties: {
          ...
          role: {
            ...
            description:
              "User role (defaults to 'user' if not provided during self-registration).",
            example: "user",
          },
          account_type: {
            type: "string",
            enum: ["company", "individual", "reseller", "agency"],
            description:
              "Type of account (e.g., individual, company, reseller).",
            example: "individual",
          },
          is_verified: {
            type: "boolean",
            description:
              "Whether the user account is verified (defaults to false).",
            example: false,
          },
          profile_photo: {
            type: "string",
          ...
          team_ids: {
            ...
            items: { type: "integer" },
            description:
              "The IDs of the teams the user belongs to within a company.",
            example: [456, 789],
            nullable: true,
          },
          designation: {
          ...
          account_person_email: {
            ...
            format: "email",
            description:
              "Email address of the account person associated with the user.",
      ...
      AuthResponse: {
        ...
        properties: {
          ...
          token: {
            type: "string",
            example:
              "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJqb2huLmRvZUBleGFtcGxlLmNvbSIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNjE2NDQ2NDA2LCJleHAiOjE2MTY1MzI4MDZ9.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c",
          },
      ...
      ContentCreationRequest: {
        ...
        properties: {
          ...
          generated_content: {
            type: "object",
            description:
              "Generated content data (JSONB) containing title and content",
            example: {
              title: "My Awesome Blog Post",
              content:
                "This is the full content of my awesome blog post in HTML format.",
            },
          },
          post_type: {
            type: "string",
      ...
      CreateWebsiteDto: {
        ...
        properties: {
          ...
          credential_type: {
            type: "object",
            description:
              "Schema defining required credential fields and their types for this website",
            example: {
              username: "string",
              password: "string",
              api_key: "string",
      ...
      UpdateWebsiteDto: {
        ...
        properties: {
          ...
          credential_type: {
            type: "object",
            description:
              "Updated schema for required credential fields and their types",
            example: {
              username: "string",
              password: "string",
              api_token: "string",
      ...
      Website: {
        ...
        properties: {
          ...
          credential_type: {
            type: "object",
            description:
              "Schema defining required credential fields and their types",
            example: {
              username: "string",
              password: "string",
              api_key: "string",
      ...
      APIKey: {
        ...
        properties: {
          ...
          credentials: {
            type: "object",
            description:
              "Actual credentials for this API key. Must match the schema defined in the linked website's credential_type.",
      ...
      APIKeyCreationRequest: {
        ...
        properties: {
          ...
          permissions: {
            ...
            items: { type: "string" },
            description:
              "Permissions for the API key (defaults to all permissions if not specified)",
            example: ["read", "write"],
            nullable: true,
          },
          expires_at: {
          ...
          credentials: {
            type: "object",
            description:
              "Credentials for the API key. Must match the schema defined in the linked website's credential_type.",
            example: { api_key: "my-key", api_secret: "my-secret" },
            nullable: true,
          },
        },
      ...
      APIKeyUpdateRequest: {
        ...
        properties: {
          ...
          credentials: {
            type: "object",
            description:
              "Updated credentials for the API key. Must match the schema defined in the linked website's credential_type.",
            example: { api_key: "my-key", api_secret: "my-secret" },
            nullable: true,
          },
        },
      ...
      Ticket: {
        ...
        properties: {
          ...
          description: {
            ...
            example:
              "I am unable to post content to my blog due to an API error.",
          },
          status: {
            type: "string",
      ...
      AIUsage: {
        ...
        properties: {
          ...
          feature: {
            ...
            description:
              "Specific AI feature used (e.g., content generation, keyword analysis)",
      ...
      Inquiry: {
        ...
        properties: {
          ...
          message: {
            ...
            example:
              "I am interested in exploring a potential partnership with your company for SEO services.",
          },
          status: {
            type: "string",
          ...
          content: {
            ...
            properties: {
              article: {
                type: "string",
                example:
                  "This is a detailed article about improving SEO in 2024...",
              },
              blog: {
                type: "string",
      ...
      SearchCampaignDto: {
        ...
        properties: {
          ...
          to_date: {
            ...
            format: "date",
            description:
              "Filter campaigns created up to this date (YYYY-MM-DD)",
            example: "2024-12-31",
            nullable: true,
          },
          status: {
  ...
  }, // <-- components closing brace
  paths: {
    "/ai/generate-all": {
      post: {
        summary: "Generate content for all platforms using AI",
        description:
          "Generates content for various platforms including articles, blogs, social media posts, etc.",
        tags: ["AI"],
        security: [{ bearerAuth: [] }], // This ensures token is required
        requestBody: {
          required: true,
          content: {
            "application/json": {
    ...
    "/api-keys/search": {
      get: {
        ...
        description:
          "OWNER and ADMIN can search all API keys. USER can only search their own API keys.",
        tags: ["API Keys"],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
        ...
        responses: {
          200: {
            description:
              "A paginated list of API keys matching the search criteria.",
            content: {
              "application/json": {
                schema: {
                  type: "object",
